...
if($_SERVER["REQUEST_METHOD"]== "POST"){
    ...
    do{
        ...
        $sql = "INSERT INTO players (PlayerID,Name,Nationality,DoB,Role,StrikeRate,BowlingStyle,BattingStyle) " .
               "VALUES ('$PlayerID','$Name','$Nationality','$DoB','$Role','$StrikeRate','$BowlingStyle','$BattingStyle')";
